export const translations = {
  ar: {
    ...
    contactUsDescription: 'سواء كنت فردًا أو شركة، يقدم مكتبنا استشارات مهنية وحلولا قانونية موثوقة.',
    ...
    // About Section
    aboutTitle: 'من نحن',
    aboutDescription: 'تأسس مكتب حسين بن أحمد آل محمد للمحاماة والاستشارات القانونية في مدينة الرياض ليكون شريكًا قانونيًا موثوقًا للأفراد والشركات والكيانات بمختلف قطاعاتها. بفضل خبرة تمتد لأكثر من ١٣ عام في سوق العمل القانوني، يقدم المكتب حلولًا قانونية متكاملة تعتمد على فهم دقيق للأنظمة السعودية والممارسات القانونية.',
    aboutHeroDescription: 'تأسس مكتب حسين بن أحمد آل محمد للمحاماة والاستشارات القانونية في مدينة الرياض ليكون شريكًا قانونيًا موثوقًا للأفراد والشركات والكيانات بمختلف قطاعاتها. بفضل خبرة تمتد لأكثر من ١٣ عام في سوق العمل القانوني، يقدم المكتب حلولًا قانونية متكاملة تعتمد على فهم دقيق للأنظمة السعودية والممارسات القانونية.',
    ...
    phone: 'الهاتف: +٦٦٩ ٠٥ ٣٢١ ٧٦٥٤',
    email: 'البريد الإلكتروني: info@almohmmed.com',
    emailLabel: 'البريد الإلكتروني',
    address: 'العنوان',
    location: 'الرياض، المملكة العربية السعودية',
    workingHours: 'ساعات العمل',
    schedule: 'الأحد - الخميس: ٩:٠٠ ص - ٦:٠٠ م',
