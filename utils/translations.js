export const translations = {
  ar: {
    // Header
    lawFirm: 'مكتب حسين أحمد آل محمد للمحاماة والاستشارات القانونية',
    home: 'الرئيسية',
    about: 'من نحن',
    services: 'خدماتنا',
    contact: 'اتصل بنا',
    ...
    // Lawyer Quote
    lawyerQuoteTitle: 'كلمة المحامي حسين بن أحمد آل محمد',
    ...
    contractsDesc: 'مراجعة وصياغة العقود، اتفاقيات الشراكة',
    realEstate: 'القضايا العقارية',
    realEstateDesc: 'منازعات الملكية، الإخلاء، إثبات الملكية',
    arbitration: 'التحكيم وتسوية النزاعات',
    arbitrationDesc: 'التحكيم المحلي، التسويات القانونية',
    ...
    schedule: 'الأحد - الخميس: 9:00 ص - 6:00 م',
    copyright: '© 2025 مكتب حسين أحمد آل محمد للمحاماة. جميع الحقوق محفوظة.',
